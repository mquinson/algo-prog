...
\begin{Reponse}
  ...
  \VerbatimInput[label=Test.java]{src/knap/Test.java}
  \VerbatimInput[label=Knapsack.java]{src/knap/Knapsack.java}
  \VerbatimInput[label=KnapsackSolution.java]{src/knap/KnapsackSolution.java}
\end{Reponse}
